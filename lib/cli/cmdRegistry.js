...
const cmdExec = require("./cmds/cmdExec");
const cmdStartClient = require("./cmds/cmdStartClient");
...
module.exports = {
    ...
    registerAllCommands: () =>
    {
        ...
        _registeredCommands[cmdExec.name] = cmdExec;
        _registeredCommands[cmdStartClient.name] = cmdStartClient;
    },
    /**
